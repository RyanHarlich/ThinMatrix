...
public class Loader {
	...
	public int loadTexture(String fileName) {
		...
		try {
			...
			// removes flickering and adds mipmaping so far away images are in low resolution
			GL30.glGenerateMipmap(GL11.GL_TEXTURE_2D);
			GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, GL11.GL_LINEAR_MIPMAP_LINEAR);
			GL11.glTexParameterf(GL11.GL_TEXTURE_2D, GL14.GL_TEXTURE_LOD_BIAS, -0.4f); // LOD: level of detail, set too negative and trade performance for detail (-1 will almost make the mipmapping unnoticeable)
