...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		/* Bunny */
		TexturedModel stanfordBunnyModel = new TexturedModel(OBJLoader.loadObjModel("stanfordBunny", loader), new ModelTexture(loader.loadTexture("white")));
		...
		/* Player */
		Player player = new Player(stanfordBunnyModel, new Vector3f(100, 0, -50), 0, 0, 0, 1);
